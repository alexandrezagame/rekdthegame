            ...
            <CardActionArea className={classes.productCard}>
              ...
              <CardContent className={classes.productContent}>
                ...
                <Typography variant="body2" color="textSecondary" component="p">
                  Every square will lead to a different hysterical action for
                  one or more players. From Challenges that play like mini-games
                  to get ahead, to Punishments that will have your friends in
            ...
            <CardActionArea className={classes.productCard}>
              ...
              <CardContent className={classes.productContent}>
                ...
                <Typography variant="body2" color="textSecondary" component="p">
                  ...
                  Challenges will have you taking sides, feuds will be created
                  and Specials will awaken the competitive spirits in the room.
                  Just remember: taking that winning selfie is everything.
                </Typography>
              </CardContent>
            </CardActionArea>
          </Card>
            ...
            <CardActionArea className={classes.productCard}>
              ...
              <CardContent className={classes.productContent}>
                ...
                <Typography variant="body2" color="textSecondary" component="p">
                  ...
                  consequences. You can take the treacherous shortcuts and try
                  to get ahead, at your own peril. You may be faced with the
                  opportunity to send a player back to the start, creating a
                  rivalry. You can decide where to send drinks and who to call
                  out on Specials. It’s up to you.
                </Typography>
              </CardContent>
            </CardActionArea>
          </Card>
